...
- Allow browser calls only from patkan.in, [www.patkan.in](http://www.patkan.in) and your Lovable preview domains; every
...
changes, **AGPL-3.0** is the stricter choice. Tell me which you want.----AGPL-3.0
